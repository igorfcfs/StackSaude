    ...
    <header className="sticky top-0 z-50 bg-white border-b border-slate-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 font-bold text-sm uppercase tracking-wider">
          ...
          <Link
            href="/protocolos"
            className={`transition-colors ${
              isActive("/protocolos") ? "text-sky-500" : "text-slate-500 hover:text-sky-500"
            }`}
          >
            Protocolos
          </Link>
          ...
          <Link
            href="/metodologia"
            className={`transition-colors ${
              isActive("/metodologia") ? "text-sky-500" : "text-slate-500 hover:text-sky-500"
            }`}
          >
            Metodologia
          </Link>
          ...
          <Link
            href="/blog"
            className={`transition-colors ${
              isActive("/blog") ? "text-sky-500" : "text-slate-500 hover:text-sky-500"
            }`}
          >
            Blog
          </Link>
          ...
          <Link
            href="/contato"
            className={`transition-colors ${
              isActive("/contato") ? "text-sky-500" : "text-slate-500 hover:text-sky-500"
            }`}
          >
            Contato
          </Link>
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-slate-100 bg-white">
          <nav className="flex flex-col items-center gap-6 py-8 font-bold uppercase text-sm">

            <Link href="/" onClick={() => setMenuOpen(false)}>Home</Link>
            <Link href="/protocolos" onClick={() => setMenuOpen(false)}>Protocolos</Link>
            ...
            <Link
              href="https://sua-area-ticto.com.br/login"
              target="_blank"
              className="mt-4 px-6 py-3 bg-slate-900 text-white rounded-full text-xs"
            >
              Área de Membros
            </Link>
